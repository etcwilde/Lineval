...
maintainers of older versions of the Linux kernel to sift through thousands of
...
The biggest challenge is computing the merge-tree of the Linux kernel repository. It
...
foxtrot merges. We are able to use our heuristic with the Linux kernel because of
