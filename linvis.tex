...
\evantodo{we need a reference to these trees}
...
The Reingold-Tilford tree (Figures \ref{fig:zoomed_tree} and \ref{fig:tree}) allows the visualization and navigation
