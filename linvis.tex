...
% merges the branches or a set of commits into the kernel.
 ...
 The contributions of this paper are two. First, we describe a method to convert the DAG of the Linux repository into a tree (we call this the tree model of the
 reposisory) that represents the path used by
