We conducted a user study of \evan{NUMBER} participants to determine if there is a
...
\evan{still need to figure out who our intended user is... ``git user'' is a bit too
  broad.}
