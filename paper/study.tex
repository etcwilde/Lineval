...
% TODO: Add the null hypotheses for each question to the procedures
% TODO: Include the Wilcoxon Test and Cliff effect size test results
...
The results for the correctness metric are summarized in
Table~\ref{tab:correctness_table}; the full results are as follows;

% TODO: add results for other metrics
