...
\begin{table}[htpb]
  \centering
  \caption{Summarization Correctness Results}
...
\begin{itemize}
  ...
  \item
    ...
    T5; The correctness results are split for this task. For \comA, the
  ...
  \item
    ...
    T9; The correctness results are split for this task. For \comA, the
