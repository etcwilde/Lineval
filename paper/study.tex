...
\begin{table}[htpb]
  \centering
  \caption{Cross-Commit Results\dmg{Be more descriptive in the captions.People read the papers via tables and
      pictures. What does the table say? e.g. as it can be seen.... tell a story with the picture, instead of asking the
    reader to make up the story... which might be different than the one you want them to have}}
...
\dmg{you wrongly use ``semicolon'', you mean ``colon''. Same below...}
...
conceptual understanding and summarization tasks; \dmg{this is another wrong use of semicolon}\tool was easier to
work with \dmg{avoid idiomatic expressions: what does ``work with'' mean? use a precise verb. English is a rich language.} than Gitk. The participants cited the ability to abstract
information about the merge from the clean summarization tables and
simple visualizations \dmg{be precise: from Linvis' clean summarization tables and ... }. Three participants suggested that someone with a
